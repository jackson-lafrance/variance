...
const deviationScenarios: DeviationScenario[] = [
  ...
  { playerCards: ['10', '3'], dealerCard: '2', trueCount: -2, correctAction: 'hit', basicStrategyAction: 'stand', description: '13 vs 2' },
  { playerCards: ['9', '4'], dealerCard: '2', trueCount: -2, correctAction: 'hit', basicStrategyAction: 'stand', description: '13 vs 2' },
  { playerCards: ['8', '4'], dealerCard: '4', trueCount: -1, correctAction: 'hit', basicStrategyAction: 'stand', description: '12 vs 4' },
  { playerCards: ['10', '2'], dealerCard: '4', trueCount: -1, correctAction: 'hit', basicStrategyAction: 'stand', description: '12 vs 4' },
  { playerCards: ['7', '5'], dealerCard: '5', trueCount: -3, correctAction: 'hit', basicStrategyAction: 'stand', description: '12 vs 5' },
  { playerCards: ['9', '3'], dealerCard: '5', trueCount: -3, correctAction: 'hit', basicStrategyAction: 'stand', description: '12 vs 5' },
  { playerCards: ['8', '4'], dealerCard: '6', trueCount: -2, correctAction: 'hit', basicStrategyAction: 'stand', description: '12 vs 6' },
  { playerCards: ['10', '2'], dealerCard: '6', trueCount: -2, correctAction: 'hit', basicStrategyAction: 'stand', description: '12 vs 6' },
  { playerCards: ['10', '3'], dealerCard: '3', trueCount: -3, correctAction: 'hit', basicStrategyAction: 'stand', description: '13 vs 3' },
  { playerCards: ['9', '4'], dealerCard: '3', trueCount: -3, correctAction: 'hit', basicStrategyAction: 'stand', description: '13 vs 3' },
];
